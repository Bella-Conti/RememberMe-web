...
export const CalendarDayStyled = styled.div<{ variant: string }>`
...
export const CalendarColStyled = styled.div<{ variant: string }>`
  flex-grow: 1;
  flex-basis: 0;
  max-width: 100%;
  height: 70px;
...
const calendarColVariant: GenericPropsObjectNested = {
  center: {
...
const calendarDayVariant: GenericPropsObjectNested = {
  row: {
    margin: 0,
    padding: 0,
    display: "flex",
